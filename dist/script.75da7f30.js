...
var speedSetting = document.querySelector('[name="speed"]');
var start = document.querySelector('[name="start"]');
var slower = document.querySelector('[name="decreaseSpeed"]');
var faster = document.querySelector('[name="increaseSpeed"]');
...
function _submitHandler() {
  _submitHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var promptSpeed, chineseTextArray, textboxArray;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          if (!speedSetting.value) {
            promptSpeed = prompt('please enter a speed (words per minute');
          ...
          chineseTextArray = textbox.value.split('');
        ...
        case 6:
          textboxArray = textbox.value.split(' ');
...
function getRandomText(_x) {
  return _getRandomText.apply(this, arguments);
}
function _getRandomText() {
  _getRandomText = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(textboxArray) {
    var randomText, randomTextArr;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return getChatGPTResponse(textboxArray.join(''));
        case 4:
          randomText = _context2.sent;
          randomText.match(/[\u4e00-\u9fff]/g) ? randomTextArr = randomText.split('') : randomTextArr = randomText.split(' ');
          textObjs["".concat(username, "'s text")] = new UserInput(randomTextArr, speedSetting.value);
          calculateTiming(textObjs["".concat(username, "'s text")]);
        case 8:
        case "end":
...
function processUserText(textboxArray) {
  console.log('working');
  textObjs["".concat(username, "'s text")] = new UserInput(textboxArray, speedSetting.value);
  textbox.value = null;
  ...
  document.querySelectorAll('.buttons').forEach(function (button) {
    return button.classList.add('animate');
  });
  calculateTiming(textObjs["".concat(username, "'s text")]);
}
function calculateTiming(_ref) {
  var text = _ref.text,
    initialSpeed = _ref.initialSpeed;
  var timeToWait = 60000 / initialSpeed;
  renderArrItems(text, timeToWait, initialSpeed);
}

//bold first character
function renderArrItems(_x2, _x3, _x4) {
  return _renderArrItems.apply(this, arguments);
}
function _renderArrItems() {
  _renderArrItems = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(array, timeToWait, initialSpeed) {
    var speedDisplay, _iterator, _step, item;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          slower.addEventListener('click', function (e) {
            ...
            speedDisplay.textContent = "".concat(parseInt(speedDisplay.textContent) - 5, " words/min");
          });
          ...
          speedDisplay.textContent = "".concat(initialSpeed, " words/min");
    ...
    }, _callee3, null, [[8, 29, 32, 35]]);
  }));
  return _renderArrItems.apply(this, arguments);
}
var i = 0;
var prevTextboxNodeContainer;
var textboxNode = document.createTextNode(textbox.value);
function selectWholeWord(_x5, _x6) {
  return _selectWholeWord.apply(this, arguments);
}
function _selectWholeWord() {
  _selectWholeWord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(textbox, item) {
    var startPos, endPos, text, selection, textNodeContainer, textboxNode, boldSpan, range;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          textNodeContainer = document.createElement("div");
          textNodeContainer.classList.add('bold-div');
          textboxNode = document.createTextNode(text);
...
function getChatGPTResponse(_x7) {
  return _getChatGPTResponse.apply(this, arguments);
}
function _getChatGPTResponse() {
  _getChatGPTResponse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(prompt) {
